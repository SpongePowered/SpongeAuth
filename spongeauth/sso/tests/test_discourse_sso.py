...
class TestSign(SignerTestCase):
    ...
    def test_sign_string(self):
        assert self.signer.sign({"nonce": "number used once"}) == (
            "bm9uY2U9bnVtYmVyK3VzZWQrb25jZQ==",
            "a42c444d01993b53fe2f189bc5af05c04f4340306bca30721e049e8417372245",
        )

    def test_sign_boolean(self):
        assert self.signer.sign({"avatar_force_update": True}) == (
            "YXZhdGFyX2ZvcmNlX3VwZGF0ZT10cnVl",
            "2012b41a566916139c96a3b659013dfb8311274ce2e76988724f4149dca444cc",
        )
